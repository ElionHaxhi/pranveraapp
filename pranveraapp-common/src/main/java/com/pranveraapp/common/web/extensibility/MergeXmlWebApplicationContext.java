...
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import com.pranveraapp.common.extensibility.context.MergeApplicationContextXmlConfigResource;
import com.pranveraapp.common.extensibility.context.ResourceInputStream;
import com.pranveraapp.common.extensibility.context.StandardConfigLocations;
import com.pranveraapp.common.extensibility.context.merge.ImportProcessor;
...
public class MergeXmlWebApplicationContext extends XmlWebApplicationContext {
    ...
    protected void loadBeanDefinitions(XmlBeanDefinitionReader reader) throws BeansException, IOException {
        String[] pranveraappConfigLocations = StandardConfigLocations.retrieveAll(standardLocationTypes);

        ArrayList<ResourceInputStream> sources = new ArrayList<ResourceInputStream>(20);
        for (String location : pranveraappConfigLocations) {
