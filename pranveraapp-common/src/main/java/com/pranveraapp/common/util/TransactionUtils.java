...
public class TransactionUtils {
     ...
     */
    public static final String DEFAULT_TRANSACTION_MANAGER = "elTransactionManager";
     ...
     */
    public static final String SECURE_TRANSACTION_MANAGER = "elTransactionManagerSecureInfo";
