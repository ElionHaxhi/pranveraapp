package com.pranveraapp.common.config;

import org.apache.commons.collections.CollectionUtils;
import org.apache.commons.lang3.StringUtils;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import com.pranveraapp.common.logging.SupportLogManager;
import com.pranveraapp.common.logging.SupportLogger;
...
public class RuntimeEnvironmentPropertiesConfigurer extends PropertyPlaceholderConfigurer implements InitializingBean {
    ...
    protected static Set<Resource> elPropertyLocations = new LinkedHashSet<Resource>();
    ...
    static {
        ...
        elPropertyLocations.add(new ClassPathResource("config/el/"));
        elPropertyLocations.add(new ClassPathResource("config/el/admin/"));
        elPropertyLocations.add(new ClassPathResource("config/el/cms/"));
        elPropertyLocations.add(new ClassPathResource("config/el/web/"));
        elPropertyLocations.add(new ClassPathResource("config/el/fw/"));
    ...
    protected Resource[] createBroadleafResource() throws IOException {
        Resource[] resources = new Resource[elPropertyLocations.size()];
        int index = 0;
        for (Resource resource : elPropertyLocations) {
