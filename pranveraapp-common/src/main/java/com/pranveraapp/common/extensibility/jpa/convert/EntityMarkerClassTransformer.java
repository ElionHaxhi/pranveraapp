...
import com.pranveraapp.common.extensibility.jpa.copy.AbstractClassTransformer;
import com.pranveraapp.common.extensibility.jpa.copy.DirectCopyIgnorePattern;
 ...
 */
public class EntityMarkerClassTransformer extends AbstractClassTransformer implements PranveraAppClassTransformer {
    ...
    @Resource(name = "elDirectCopyIgnorePatterns")
    ...
    public void setTransformedEntityClassNames(HashSet<String> transformedEntityClassNames) {
        this.transformedEntityClassNames = transformedEntityClassNames;
    }
