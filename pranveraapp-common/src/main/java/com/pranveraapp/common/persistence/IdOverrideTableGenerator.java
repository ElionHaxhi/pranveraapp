package com.pranveraapp.common.persistence;
...
public class IdOverrideTableGenerator extends TableGenerator{
	...
	public Serializable generate(SessionImplementor session, Object obj) {
		/*
		 * This works around an issue in Hibernate where if the entityPersister
		 * is retrieved from the session and used to get the Id, the entity
		 * configuration can be recycled, which is messing with the load
		 * persister and current persister on some collections. This may be a
		 * jrebel thing, but this workaround covers all environments
		 */
